...
model_choices = ["SwinCS_VFIT_S", "SwinCS_VFIT_B"]
model_arg.add_argument('--model', choices=model_choices, type=str, default="SwinCS_VFIT_B")
...
learn_arg.add_argument('--lr', type=float, default=2e-4)  # 梯度爆炸
learn_arg.add_argument('--beta1', type=float, default=0.9)
learn_arg.add_argument('--beta2', type=float, default=0.999)
# learn_arg.add_argument('--batch_size', type=int, default=4)  # batch_size=4爆显存RTX3060 6G
...
learn_arg.add_argument("--load_from"  ,type=str , default='checkpoints/SwinCS_VFIT_B/model_best.pth')
