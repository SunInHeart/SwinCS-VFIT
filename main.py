...
save_loc = os.path.join(args.checkpoint_dir, f"checkpoints/{args.model}")
...
# # Learning rates for SwinCS-VFIT-S training
# lr_schular = [2e-4, 1e-4, 5e-5, 2.5e-5, 5e-6, 1e-6]
# For SwinCS-VFIT-B
lr_schular = [5e-4, 2e-4, 1e-4, 5e-5, 2.5e-5, 1e-5, 5e-6]
training_schedule = [40, 60, 75, 85, 90, 95, 100]
